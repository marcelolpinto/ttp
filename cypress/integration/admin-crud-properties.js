...
const ID = '5d7568014dffd96fbfd2858f';
...
describe('Admin CRUD Properties', function() {
  it('CRUDs Properties', function() {
    cy.server();
    ...
    cy.get('button#properties').click();
    cy.wait(200);
    ...
    cy.get('div#select-realtorId').click();
